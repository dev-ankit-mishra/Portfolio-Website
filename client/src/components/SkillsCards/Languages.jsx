...
const languagesItems = [
  {
    id: 1,
    icon: <SiC className="text-2xl xl:text-3xl  text-blue-500" />,
    label: "C",
    tooltip: "Low-level system programming language",
  },
  {
    id: 2,
    icon: <FaJava className="text-2xl xl:text-3xl  text-red-600" />,
    label: "Java",
    tooltip: "Object-oriented programming for cross-platform apps",
  },
  {
    id: 3,
    icon: <SiTypescript className="text-2xl xl:text-3xl  text-blue-400" />,
    label: "TypeScript",
    tooltip: "Typed superset of JavaScript",
  },
  {
    id: 4,
    icon: <SiJavascript className="text-2xl xl:text-3xl text-yellow-400" />,
    label: "JavaScript",
    tooltip: "The language of the web",
  },
  {
    id: 5,
    icon: <SiCplusplus className="text-2xl xl:text-3xl text-indigo-400" />,
    label: "C++",
    tooltip: "Powerful language for performance-critical applications",
  },
  {
    id: 6,
    icon: <SiPython className="text-2xl xl:text-3xl text-yellow-300" />,
    label: "Python",
