...
const DatabaseItems = [
  {
    id: 1,
    icon: <SiMongodb className="text-2xl xl:text-3xl text-green-600" />,
    label: "MongoDB",
    tooltip: "NoSQL database for flexible document storage",
  },
  {
    id: 2,
    icon: <SiPostgresql className="text-2xl xl:text-3xl text-sky-600" />,
    label: "PostgreSQL",
    tooltip: "Powerful open-source relational database",
  },
  {
    id: 3,
    icon: <SiMysql className="text-2xl xl:text-3xl text-blue-400" />,
    label: "MySQL",
    tooltip: "Popular relational database for web apps",
  },
  {
    id: 4,
    icon: <SiFirebase className="text-2xl xl:text-3xl text-yellow-400" />,
    label: "Firebase",
